...
cover:
    image: "kinder.jpg"
    alt: "Programmier-Anfänger bei der Arbeit"
    caption: "Programmier-Anfänger bei der Arbeit"
    relative: true
    hidden: false
weight: 10
---
...
**Ihr kommt vorbei, wenn ihr Lust und Zeit habt.**

**Wiener Dojos finden in der Regel alle zwei wöchentlich statt. Tullner Dojos üblicherweise am letzten Freitag im Monat. **
...
Bitte schaut mit euren Eltern die [Informationen für Eltern]({{< relref "/infos/eltern" >}}) aufmerksam durch. Falls Ihr jünger als 13 Jahre alt seid, muss eine erwachsene Begleitperson mit euch zum CoderDojo kommen und die ganze Zeit anwesend bleiben.
...
### Für Bastler: [Micro:bit](https://microbit.org/ "Homepage von Micro:bit")

Egal ob du schon programmiert hast oder nicht, beim [Micro:bit](https://microbit.org/ "Homepage von Micro:bit") bist du als gut aufgehoben, wenn du die Dinge gerne _in die Hand_ nimmst. Du lernst damit die Grundlagen von Programmierung ebenfalls auf ganz einfache, grafische Art oder alternativ hier auch in JavaScript oder Python. Du kannst deine Projekte mit anderen teilen oder auf Projekten anderer aufbauen.

Den Micro:bit kannst du dabei, wenn du bastlersich und elektronisches begabt bist, auch für eigene Schaltungen verwenden.
...
Na dann, sprich mit deinen Eltern, ob sie einverstanden sind. Falls ja, melde dich gleich zu deinem erste Besuch beim CoderDojo Tulln oder Wien an und schau bei uns vorbei.
